<x-layouts.lootbay title="LootBay - Admin Vendas">
        ...
        <div class="relative z-10">
            ...
            <div class="mt-8 mx-auto w-[min(1140px,92vw)]">
                ...
                <div class="flex flex-col md:flex-row justify-between items-end gap-4">
                    <div>
                        <h1 class="font-['Bebas_Neue'] text-[clamp(2rem,5vw,3rem)] uppercase tracking-[0.12em] text-white">Todas as Vendas</h1>
                        <p class="text-white/60">Visualização administrativa de todas as vendas realizadas no site.</p>
                    </div>
                    <div class="flex gap-2">
                        <a href="{{ route('admin.sales.pdf', request()->only('start_date', 'end_date')) }}"
                        ...
                        <a href="{{ route('admin.sales.excel', request()->only('start_date', 'end_date')) }}"
    ...
    <section class="py-10">
        <div class="mx-auto w-[min(1140px,92vw)]">
            ...
            {{-- Date filter --}}
            <form method="GET" action="{{ route('admin.sales.index') }}" class="mb-8 flex flex-wrap items-end gap-4 rounded-2xl border border-white/10 bg-white/5 p-5">
                <div>
                ...
                @if(request('start_date') || request('end_date'))
                    <a href="{{ route('admin.sales.index') }}" class="px-5 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm transition">
            ...
            @if($sales->isEmpty())
                <div class="rounded-2xl border border-white/10 bg-white/5 p-12 text-center">
                    ...
                    <p class="text-white/40 text-lg">Nenhuma venda encontrada.</p>
                </div>
            @else
                <div class="space-y-6">
