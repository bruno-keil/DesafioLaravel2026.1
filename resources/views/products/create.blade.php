<x-layouts.lootbay title="LootBay - Anunciar Produto">
    <header class="relative overflow-hidden py-8">
        <div class="relative z-10">
            ...
            <div class="mt-8 container-main">
                ...
                <h1 class="page-title">Anunciar Produto</h1>
            </div>
        </div>
    </header>
    ...
    <section class="py-10 pb-20">
        <div class="container-main">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="glass-card p-8 backdrop-blur-sm space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <input type="text" name="nome" value="{{ old('nome') }}" class="form-input-dark" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="preco" step="0.01" value="{{ old('preco') }}" class="form-input-dark" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="quantidade" value="{{ old('quantidade') }}" class="form-input-dark" required>
                            <x-input-error :messages="$errors->get('quantidade')" class="mt-1" />
                        </div>

                        <div>
                            <label class="form-label-dark">Descrição</label>
                            <textarea name="descricao" rows="4" class="form-input-dark" required>{{ old('descricao') }}</textarea>
                ...
                <div class="pt-4 flex justify-end gap-3 border-t border-white/10">
                    <a href="{{ route('products.my') }}" class="btn-ghost">Cancelar</a>
